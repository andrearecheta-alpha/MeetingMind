...
**Core ICP:** Knowledge workers in high-stakes meetings who need real-time
intelligence — EAs, PMs, Sales Engineers, C-Suite, Consultants.

### Primary: Executive Assistants
Gatekeepers to the C-suite, managing calendars, follow-ups, and protocols.
Pain: tracking commitments made by executives across dozens of meetings; ensuring nothing slips.
Outcome sought: automatic follow-up capture, executive preference awareness, protocol compliance.
...
## Phase 3 — Jarvis Expansion

*(Sprint 9+, after first paying customer)*

MeetingMind evolves into an always-on AI Chief of Staff:

### Between meetings
- Daily briefing generated from KB
- Action item follow-up tracking
- Pre-meeting context briefs

### Mobile
- React Native app
- Offline capable (llama.cpp)
- Biometric security

### Full EA replacement for solo CEOs
- Calendar awareness
- Task planning
- Memory retrieval
- Voice interface

Reference: Jarvis architecture doc saved in `docs/JARVIS_VISION.md`

---

## MeetingMind Differentiators

### What Makes Us Different

**1. We Don't Join Your Meeting**

Unlike Otter.ai and Fireflies.ai, MeetingMind never joins as a bot participant.
No "recording bot" in your meeting. No one knows you're using it.
100% invisible to other participants. Privacy-first by design.

Works with ANY meeting platform: Zoom, Teams, Google Meet, Webex,
in-person, phone calls — any audio source.

**2. Not Just for Meetings**

Works during 1:1 conversations, phone calls, brainstorming sessions,
client presentations, job interviews — any conversation worth remembering.

**3. Smartglass Integration (Planned — Phase 4)**

MM coaching appears in your field of vision via smartglass HUD.
No need to glance at laptop. Truly hands-free meeting intelligence.

Target devices:
- Meta Ray-Ban glasses
- Google Glass Enterprise
- Microsoft HoloLens
- Any BLE-connected display

---

## Competitive Positioning

| Capability | Otter.ai | Fireflies.ai | MeetingMind |
|---|---|---|---|
| Invisible to others | Joins as bot | Joins as bot | Invisible |
| Audio processing | Cloud | Cloud | 100% local |
| Real-time coaching | No | No | Yes |
| Fact-checking | No | Post-meeting only | Sprint 7 |
| Works everywhere | Meeting platforms only | Meeting platforms only | Any audio source |
| Smartglass ready | No | No | Phase 4 |
| Privacy guarantee | No | No | Yes — audio never leaves device |
